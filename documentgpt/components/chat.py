...
from documentgpt.components import loading_icon
from documentgpt.state import QA, State
...
def action_bar() -> rx.Component:
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.text(
                "DocumentGPT returns answers based on the content fed in. Use discretion.",
                font_size="xs",
                color="#fff6",
                text_align="center",
            ),
